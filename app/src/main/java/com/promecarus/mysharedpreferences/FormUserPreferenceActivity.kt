package com.promecarus.mysharedpreferences
...
import com.promecarus.mysharedpreferences.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveUser(
        name: String, email: String, age: String, phoneNo: String, isLoveMU: Boolean
    ) {
